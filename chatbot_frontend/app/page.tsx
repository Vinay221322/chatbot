...
// Function to format text with headings and topics
function formatMessageText(text: string) {
  ...
  lines.forEach((line, index) => {
    ...
    if (trimmedLine.match(/^#{1,6}\s+/)) {
      ...
      formattedLines.push(
        <div key={index} className="font-bold text-gray-900 mt-3 mb-2 first:mt-0 underline">
          {trimmedLine}
        </div>
      )
...
export default function ChatPoleInterface() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Hello! I'm ChatPole AI Assistant. How can I help you today?",
      isUser: false,
      timestamp: new Date("2025-01-01T02:35:00"),
    },
  ])
    ...
    if (isWhoAreYouQuestion) {
      setTimeout(() => {
        const botMessage: Message = {
          ...
          text: "I'm Chatpole AI Assistant 🤖 — your smart companion powered by advanced language models. I'm here to help you with information, automation, and support — all crafted by the Chatpole team.",
          isUser: false,
          timestamp: new Date(),
        }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center h-14 sm:h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg sm:text-xl font-bold text-gray-800">ChatPole</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="text-center mb-4 sm:mb-8 px-4">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-3 mb-3 sm:mb-4">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <h1 className="text-xl sm:text-3xl font-bold text-white">ChatPole AI Assistant</h1>
              </div>
      ...
      <footer className="bg-gray-100 py-4 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center items-center space-x-4 sm:space-x-8 mb-2 sm:mb-4 text-sm sm:text-base">
            <a href="#" className="text-gray-600 hover:text-gray-900 mb-2 sm:mb-0">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-600 hover:text-gray-900 mb-2 sm:mb-0">
              Terms of Service
          ...
          <div className="text-center text-gray-600 text-sm sm:text-base">
            <p>© 2025 ChatPole. Built with ❤️ using advanced AI technology</p>
          </div>
        </div>
      </footer>
    </div>
